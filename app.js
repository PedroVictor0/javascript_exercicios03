...
//let tempfood = brazilianFoods.push("coxinha", null,"brigadeiro")
...
*/
const numItens = brazilianFoods.length
const foodsInfo = `Até aqui, o array "brazilianFoods" possui ${numItens} itens: ${brazilianFoods.toString()}.`;
...
console.log(`A ${dessert.replace("n", "d")} é um doce à base de coco, tradicional na Ámerica Latina e em Angola.`)
